...
![image.png](/public/static/images/이미지1.png)
...
![image.png](/public/static/images/이미지2.png)
...
## **DNS 스푸핑**과 **DNS 캐시 포이즈닝**

![image.png](/public/static/images/이미지3.png)
...
1. `DNSCachePoisoningServer`를 실행한다.
2. 클라이언트(예: `nslookup example.com 127.0.0.1`)로 DNS 요청을 보낸다.
3. 캐시에 가짜 IP 주소(`192.168.1.100`)가 삽입된 것을 확인한다.
...
![image.png](/public/static/images/이미지4.png)
